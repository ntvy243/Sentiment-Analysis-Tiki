...
for filename in files:
    df = pd.read_csv(os.path.join(directory, "comment", filename))
...
# Drop duplicates
mergedproduct = mergedproduct.drop_duplicates(subset=['customer_id'])
...
if num_rows > 0:
    ...
    mergedproduct_filename = f"mergedcomment_{current_datetime}.csv"

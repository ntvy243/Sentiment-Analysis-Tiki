...
# Folder path
folder_path = "d:\KHÓA LUẬN TỐT NGHIỆP\CrawlData"
...
headers = {
    ...
    'Referer': 'https://tiki.vn/cham-soc-co-the/c1592',
...
params = {
    ...
    'aggregations': '2',
    'trackity_id': '4df6a159-9dd9-4386-04e0-f8e7e7cf163f',
    'category': '1592',
    'page': '1',
    'src': 'c1592',
    'urlKey':  'cham-soc-co-the',
}
...
df.to_csv('crawl_productbody_id.csv', index=False)